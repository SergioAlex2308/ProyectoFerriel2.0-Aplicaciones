          ...
          <div class="contentModal">
            ...
            <div class="PictureControls">
              <div class="InstControls">
                ...
                <p class="textControls">Haz clic izquierdo y arrastra para mover la vista.</p>
              </div>
            </div>
            <h3 class="titleControls">Controles en la vista de primera persona</h3>
            <div class="PictureControls">
              <div class="InstControls">
                <div class="invert">
                  <img
                ...
                <p class="textControls">Con las teclas A, W, S y D, te podras desplazar a través de entorno.</p>
              </div>
              <div class="InstControls">
                <div class="invert">
                  <img
                ...
                <p class="textControls">Haz clic derecho para poder mover la cámara y mirar a tu alrededor.</p>
              </div>
              <div class="InstControls">
                <div class="invert">
                  <img
                ...
                <p class="textControls">Cuando tenga el cursor bloqueado dale a la tecla de Escape para liberarlo.</p>
              </div>
            </div>
          </div>
        </div>
